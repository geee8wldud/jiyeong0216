...
import com.example.admin.clothes.AppConfig;
import com.example.admin.clothes.AppController;
import com.example.admin.clothes.R;
import com.example.admin.clothes.Register;
                ...
                request = GraphRequest.newMeRequest(result.getAccessToken(), new GraphRequest.GraphJSONObjectCallback() {
                    ...
                    public void onCompleted(JSONObject user, GraphResponse response) {
                        if (response.getError() != null) {
                            ...
                            try {
                                AppController.userEmail = user.getString("email");
                                AppController.userName = user.getString("name");
                            } catch (JSONException e) {
                                e.printStackTrace();
                            }
